...
#KNOWN ISSUES:
    ...
    #Quitter function is messy on some quits and doesn't reset counters properly on resets
#TO DO:
    #Neaten up presentation so its more consistent with screen clearing etc
    #Autosave every 50 words
...
output = projectname = "" #initialise output in case user tries to output it before it is created
wordcount = targetwordcount = lastchar = 0 #initialise wordcount and lastchar
